...
const allCourses: Course[] = [
  ...
  {
    name: 'Kubernetes: Orquestração de Containers',
    platform: 'Alura',
  ...
  {
    name: 'CI/CD: Integração e Deploy Contínuo',
    platform: 'Alura',
...
const coursesByYear = computed<YearGroup[]>(() => {
  ...
  // Ordenar os anos em ordem decrescente, mas manter "Planejados" por último
  const sortedYears = Object.keys(grouped).sort((a, b) => {
    if (a === 'Planejados') return 1
    if (b === 'Planejados') return -1
    return parseInt(b) - parseInt(a)
  })

  // Retornar um array de objetos para garantir a ordem
